...
import tensorflow
from ot2_gym_wrapper_V2_Reward3 import OT2Env
...
task = Task.init(project_name='Mentor Group K/Group 1/DaanQuaadvliet', task_name='DaanQuaadvliet_Final_model_Iteration2_Reward3')
